...
export default function PersonDetailModal({ person, onClose }: PersonDetailModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4">
            ...
            <Card className="card-galactic p-3 sm:p-4 max-w-2xl w-full relative z-10 max-h-[90vh] overflow-hidden flex flex-col">
                <div className="flex items-center justify-between mb-3 sm:mb-4 flex-shrink-0">
                    <h2 className="text-lg sm:text-xl font-bold text-[#E5E7EB]">{person.name}</h2>
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={onClose}
                ...
                <div className="overflow-y-auto flex-1">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                        <div className="space-y-3">
                            <div>
                                <h3 className="text-sm sm:text-base font-semibold text-[#60A5FA] mb-2">Physical</h3>
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        <span className="text-[#94A3B8]">Hair:</span>
                                        <span className="text-[#E5E7EB]">{person.hair_color}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-[#94A3B8]">Skin:</span>
                                        <span className="text-[#E5E7EB]">{person.skin_color}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span className="text-[#94A3B8]">Eyes:</span>
                        ...
                        <div className="space-y-3">
                            <div>
                                <h3 className="text-sm sm:text-base font-semibold text-[#2DD4BF] mb-2">Personal</h3>
                                <div className="space-y-1.5">
                                    <div className="flex justify-between text-sm">
                            ...
                            <div>
                                <h3 className="text-sm sm:text-base font-semibold text-[#F87171] mb-2">Statistics</h3>
                                <div className="space-y-1.5">
                                    <div className="flex justify-between text-sm">
