    ...
    return (
        ...
        >
            <div className="flex items-start space-x-3 mb-3">
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${getVehicleClassColor(vehicle.vehicle_class)} flex items-center justify-center shadow-[0_0_20px_rgba(96,165,250,0.3)]`}>
